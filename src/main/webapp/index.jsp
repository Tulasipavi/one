...
<body>
	...
	<h2 style="color: yellow; font-size: 30px;" align="center">THIS IS MANULA DEPLOYMENT</h2>
        ...
        <h2 style="color: blue; font-size: 30px;" align="center">Nexus is intergrated with jenkins, War file is deployed and new version is also updated once commited changes</h2>
